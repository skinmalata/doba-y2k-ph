...
$stmt = $pdo->prepare(
    'SELECT id, username, first_name, last_name, photo, bio, graduation_year, phone, email, role, created_at
...
<div class="mb-3">
    <a href="/members/index.php" class="text-decoration-none">&larr; All Members</a>
</div>
            ...
            <div class="card-body">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <a href="/minutes/view.php?id=<?= $m['id'] ?>"><?= e($m['title']) ?></a>
